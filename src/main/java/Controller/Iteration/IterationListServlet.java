        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("addIteration")) {
                ...
                if (submit == null) {
                    ...
                    request.getRequestDispatcher("/jsp/Iteration/addIteration.jsp").forward(request, response);
                } else {
            ...
            if (service.equals("listAllIteration")) {
                ...
                if (submit == null) {
                    ...
                    request.getRequestDispatcher("/jsp/Iteration/listIteration.jsp").forward(request, response);
                } else {
            ...
            if (service.equals("updateIteration")) {
                ...
                if (submit == null) {
                    ...
                    request.getRequestDispatcher("/jsp/Iteration/updateIteration.jsp").forward(request, response);
                } else {
