...
<html lang="en">
    ...
    <head>
        ...
        <title>G1 - Update Tracking</title>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="UpdateTracking" method="POST">         
                                        ...
                                        <li>
                                            Team: <br>
                                            <input type="text" class="form-control form-control-user team_id" name="${a.team_id_id}" value=" ${a.team_name}" readonly/>
                                            ...
                                            <select class="form-control form-control-user milestone_id" name="milestone_id">
                                                <c:forEach var="o" items="${lMilestone}">
                                                    <c:if test="${milestone_id != null}">
                                                        <option value="${o.milestone_id}" ${milestone_id == o.milestone_id ? "selected" : ""}>${o.iterationName}</option>
                                                    </c:if>
                                                    <c:if test="${milestone_id == null}">
                                                        <option value="${o.milestone_id}" ${a.milestone_name == o.iterationName ? "selected" : ""}>${o.iterationName}</option>
                                                    </c:if>
                                                </c:forEach>
                                            </select>
                                            <span id=""></span>
                                        ...
                                        <li>
                                            Assigner: <br>
                                            <input type="text" class="form-control form-control-user assigner_id" name="${a.assigner_id}" value="${a.assigner_name}" readonly/>
                                    ...
                                    </form><input type="submit" onclick="Confirm()" class="form-control form-control-user ongoingeval" value="Update" style="width: 100px"/>
                                </div>           
                            </div>
                        </div>
            ...
            <jsp:include page="../LogOut.jsp"></jsp:include>
                ...
                <script>
                                        ...
                                        function Confirm() {
                                            ...
                                            var idConfirm = "UpdateAllTracking";
                                            $.ajax({
                                                url: "/g1/Confirm",
                                                type: "get",
                                                data: {
